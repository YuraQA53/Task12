...
public class CinemaManagerTest {
    ...
    Poster poster8 = new Poster("8", "Довод", 2020, "http8");
    Poster poster9 = new Poster("9", "Последний богатырь: Корень зла", 2020, "http9");
    Poster poster10 = new Poster("10", "Зов предков", 2020, "http10");
    Poster poster11 = new Poster("11", "Не время умирать", 2020, "http11");
    ...
    @Test
    public void Save() {
        CinemaManager poster = new CinemaManager();
        poster.Save(poster1);
        poster.Save(poster2);
        poster.Save(poster3);
